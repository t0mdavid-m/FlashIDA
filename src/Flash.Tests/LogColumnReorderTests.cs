...
namespace Flash.Tests
{
    ...
    public class LogColumnReorderTests
    {
        ...
        // 30), parent_tracking_id is index 3 (the OLD masked index), scan_description index 28.
        ...
        // index 3) would be masked and enqueue_ts (now index 30) would survive — both asserts would fail.
        [Test]
        public void NameBasedNormalize_MasksAndRelabelsByName_UnderNewColumnOrder()
        {
            ...
            row[30] = "999";    // enqueue_ts (must be masked to <TS> BY NAME at its new last position)
